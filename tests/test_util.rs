...
//!
//! Re-exports the crate's `test_util` helpers when the `test-util` feature is
//! enabled. When the feature is absent, lightweight stand-ins are provided so
//! tests can compile and assert over parser errors without requiring the
//! feature.

#[cfg(feature = "test-util")]
pub use ddlint::test_util::*;
